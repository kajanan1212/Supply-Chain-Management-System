    ...
    render() {
        return (
            <div className='rounded border border-secondary border-2 m-4' style={{ minHeight: '200px', width: '500px', background: '#eee', padding: '10px', fontSize: '15px', fontFamily: 'times new roman' }}>
                <div className="row">
                    <div className="col-7">
                        <p className='fw-bolder' style={{ fontSize: '20px', marginBottom: '-2px' }}>{this.props.item.title}</p>
                    ...
                    <div className="col-5">
                        <img src={require("../../Images/blue-tshirt.jpg")} alt="adsakk" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
                    </div>
                </div>
            </div>
        );
